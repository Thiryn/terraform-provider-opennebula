...
resource "opennebula_virtual_router_nic" "nic_floating_IP_specified" {
 depends_on        = [opennebula_virtual_router.test, opennebula_virtual_router_instance.test, opennebula_virtual_network.network3]
 ip 				= "172.16.100.160"
 floating_ip		= true
 virtual_router_id = opennebula_virtual_router.test.id
 network_id        = opennebula_virtual_network.network3.id
...
resource "opennebula_virtual_router_nic" "nic_IP_specified" {
  depends_on        = [opennebula_virtual_router_instance.test, opennebula_virtual_network.network2]
  ip 				= "172.16.100.120"
  virtual_router_id = opennebula_virtual_router.test.id
  network_id        = opennebula_virtual_network.network2.id
}
...
resource "opennebula_virtual_router_nic" "nic_floating_IP_specified" {
 depends_on        = [opennebula_virtual_router_instance.test, opennebula_virtual_network.network3]
 ip 				= "172.16.100.160"
 floating_ip		= true
 virtual_router_id = opennebula_virtual_router.test.id
 network_id        = opennebula_virtual_network.network3.id
